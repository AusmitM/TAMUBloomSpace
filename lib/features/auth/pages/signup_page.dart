    ...
    try {
      ...
      if (mounted) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content:
                Text('Account created successfully! Welcome to Bloom Space.'),
                ...
                children: [
                  ...
                  TextFormField(
                    ...
                    validator: (value) {
                      ...
                      // Optional: Enforce TAMU email
                      // if (!value.endsWith('@tamu.edu')) {
                      //   return 'Please use your TAMU email';
                      // }
                      return null;
                    },
                  ),
